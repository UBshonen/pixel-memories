...
**갱신일** 2026-08-25 (면접 문서 계획) · **브랜치** main
...
지원 시작은 2026-11 무렵이다. **개발이 먼저고 면접 문서는 그 뒤다.**
...
**방명록까지 끝나면 면접 문서를 정리한다.** `docs/INTERVIEW.md` 를 개발 시간순으로
다시 짜기로 했다. 지금 쓰지 않는 이유는 방명록이 "서버가 없다" 장을 통째로 뒤집기
